...
// killspams 
	switch( (int)seth.value[VAR_KSPAM] ){
		...
		case ETH2:
			...
			break;
		case ETH4:
			strncpy(ksFormat, "^2[n] ^7[8]",sizeof(ksFormat));
			break;
		case ETH5:
			strncpy(ksFormat, "^2[n]^7's World was rocked! ^1[6]",sizeof(ksFormat));
			break;
		case AEK:
		...
		case ETH32:
			...
			break;
		case SSS:
			strncpy(ksFormat, "^1[n] [s] [F]",sizeof(ksFormat));
			break;
		case BIT:
			strncpy(ksFormat, "^1[v] ^7was BITCHED! [BitcheZ: ^1[t]^7][A]",sizeof(ksFormat));
			break;
		case NOOB:
			strncpy(ksFormat, "^1[v] ^7Was captured by the noob police! [Noobs Pwnt: ^1[t]^7][O]",sizeof(ksFormat));
			break;
		case SIR1:
			strncpy(ksFormat, "^7[v] ^1[J] [O]",sizeof(ksFormat));
			break;
		case SIR2:
			strncpy(ksFormat, "^1[v] ^7[Y] ^7[Kills: ^1[t]^7]",sizeof(ksFormat));
			break;
		case PWND:
			strncpy(ksFormat, "^3<< ^7[v] ^1was pwned! ^7(Pwns: ^3[t]^7) ^3>>[O]",sizeof(ksFormat));
			break;
		case HIP:
			strncpy(ksFormat, "^6[n] ^7Tha Hip-Hop a' Don't Stop! ^1[[^7[O]^1]]",sizeof(ksFormat));
			break;
		case RAB:
			strncpy(ksFormat, "^2[n] ^nWas eaten by a Rabbit (0.o)^2[^8rabbit status:^7[I]^2]",sizeof(ksFormat));
			break;
		case LIFE:
			strncpy(ksFormat, "^2[v] ^3Sometimes life's a bitch!^2(Total: ^3[t]^2)",sizeof(ksFormat));
			break;
                default:
                        break;
 }
