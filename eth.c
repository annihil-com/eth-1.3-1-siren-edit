			...
			switch (in[a+1]) {
				...
				case 'c':
					...
					case '6': {
						char *multikillmsg;
						if (eth.killSpreeCount == 2) {
							multikillmsg = "^1!^7Double:Rocker^1!";
					}
					else if (eth.killSpreeCount == 3) {
							multikillmsg = "^1!^7Multi:Rocker^1!";
					}
					else if (eth.killSpreeCount == 4) {
						
							multikillmsg = "^1!^7Ultra:Rocker^1!";
					}
					else if (eth.killSpreeCount == 5) {
							multikillmsg = "^1!!^7Monster:Rocker^1!!";
					}
					else if (eth.killSpreeCount > 6) {
							multikillmsg = "^1!!^7Holy Shit RoOoCker^1!!";
					}
					
					else
						break;
						if (eth.killSpreeCount >= 2)
						sprintf(out, multikillmsg, sizeof(out));	
						break;
					}
					case 'R': {
						char *msg;
					...
					case 'Q': {
						...
						if (eth.killCount) { 
						if (!randmsg)
							killmsg = " ^7Eat My Bullet mutherfucka!";
			
						else if (randmsg == 1)
							killmsg = " ^7Why do u even bother playing the game... NOOB?";
						else if (randmsg == 2)
							killmsg = " ^7Cold steel makes you howl like a bitch!";
						else if (randmsg == 3)
							killmsg = " ^7I'll tear ya head off, and shit down ya neck!";
						else if (randmsg == 4)
							killmsg = " ^7Lay down and die!";
						else if (randmsg == 5)
							killmsg = " ^7DAMN, noob you suck!";
						else if (randmsg == 6)
							killmsg = " ^7Get that crap outta here!";
						else if (randmsg == 7)
							killmsg = " ^7Its time to give up, 3 . 2 . 1 . ... ^1BOOM! TOO LATE!";
						else if (randmsg == 8)
							killmsg = " ^7Come get some^1.";
						else if (randmsg == 9)
							killmsg = " ^7Bang, bang, i shot u down!";
						else if (randmsg == 10)
							killmsg = " ^7Was wasted!";
						else if (randmsg == 11)
							killmsg = " ^7You are the weakest link, goodbye!";
						else if (randmsg == 12)
							killmsg = " ^7Welcome to my spree list!";
						
						else
							killmsg = " ^7this map aint big enough for the both of us!";
						}
						else
							break;
					...
					case 'A': {
						...
						if (eth.killSpreeCount == 2) {
							if (!randmsg)
							multikillmsg = "DOUBLE BITCH SLAP";
						else if (randmsg == 1)
							multikillmsg = "PERFECT SLAP";
						else
							multikillmsg = "BITCHED";
						}
						else if (eth.killSpreeCount == 3) {
							if (!randmsg)
							multikillmsg = "TRIPLE SLAP";
						else if (randmsg == 1)
							multikillmsg = "GODLIKE SLAP";
						else
							multikillmsg = "LUDICROUS SLAP";
						}
						else if (eth.killSpreeCount == 4) {
							if (!randmsg)
							multikillmsg = "BITCH DOMINATING";
						else if (randmsg == 1)
							multikillmsg = "ULTRA SLAP";
						else
							multikillmsg = "MEGA BITCH";
						}
						else if (eth.killSpreeCount > 4) {
							if (!randmsg)
							multikillmsg = "WICKED BITCH";
						else if (randmsg == 1)
							multikillmsg = "MONSTER SLAP";
						else
							multikillmsg = "BITCH MUST DIE!";
						}
						else
							break;
						strncat(out, multikillmsg, sizeof(out));
					...
					case 'O': {
						...
						if (eth.killSpreeCount == 2) {
							...
							if (!randmsg)
								multikillmsg = " ULTRAKILL";
							else if (randmsg == 1)
								multikillmsg = " UNSTOPPABLE";
							else
								multikillmsg = " ULTRAKILL";
						}
						else if (eth.killSpreeCount > 4) {
							if (!randmsg)
								multikillmsg = " MONSTERKILL";
							else if (randmsg == 1)
								multikillmsg = " WICKED-SICK";
							else
								multikillmsg = " HOLY.MONSTER.ULTRA.SHIT";
						}
						else
							break;
						strncat(out, multikillmsg, sizeof(out));
					...
					case 'I': {
						...
						if (eth.killSpreeCount == 2) {
							if (!randmsg)
								multikillmsg = " EVIL RABBIT";
							else if (randmsg == 1)
								multikillmsg = " EVIL RABBIT";
							else
								multikillmsg = " DECIEVING RABBIT";
						}
						else if (eth.killSpreeCount == 3) {
							if (!randmsg)
								multikillmsg = " CARROT MUNCHER";
							else if (randmsg == 1)
								multikillmsg = " RABBIT HENCHMAN"; 
							else
								multikillmsg = " CARROT MUNCHER"; 
						}
						else if (eth.killSpreeCount == 4) {
							if (!randmsg)
								multikillmsg = " RABBIT GENIUS";
							else if (randmsg == 1)
								multikillmsg = " PLOTTING RABBIT";
							else
								multikillmsg = " RABBIT GENIUS";
						}
						else if (eth.killSpreeCount > 4) {
							if (!randmsg)
								multikillmsg = " CARROT TRAINING CORP.";
							else if (randmsg == 1)
								multikillmsg = " EVIL RABBIT MASTERMIND";
							else
								multikillmsg = " EVIL RABBIT MASTERMIND";
						}
						else
					...
					case 'J': {
						...
						if (eth.killCount) {
						if (!randmsg)
							killmsg = " ^7 Die bitch, die!";
						else if (randmsg == 1)
							killmsg =  "^7 Come get some...^1NOOB";
						else if (randmsg == 2)
							killmsg = " ^7 Go get screwed!";
						else if (randmsg == 3)
							killmsg =  "^7 Ha bitch!";
						else if (randmsg == 4)
							killmsg =  "^7 I win, u loose!";
						else if (randmsg == 5)
							killmsg = " ^1 BOOM!^7 Headshot!";
						else if (randmsg == 6)
							killmsg = "^7 Get bent!";
						else if (randmsg == 7)
							killmsg = "^7 Come try that on me smart-arse!";
						else if (randmsg == 8)
							killmsg = "^7 Lead to ya head, and a bullet through ya brain!";
						else if (randmsg == 9)
							killmsg =  " ^7 Have fun, ...rest in pieces! ";
						else if (randmsg == 10)
							killmsg = " ^7 Wanted to take part in my killingspree!";
						else if (randmsg == 11)
							killmsg = " ^7 BOOM, BOOM, ^7Shake tha room! ";
						else if (randmsg == 12)
							killmsg = " ^7 is no longer a living noob!";
						else if (randmsg == 13)
							killmsg = "^7 It's time to kick ass, and chew bubblegum... and i'm all outta gum!";
						else if (randmsg == 14)
							killmsg = "^7 Die mother-fucker, Die!";
						else if (randmsg == 15)
							killmsg = "^7 Come get some...If ya think ya hard enough!";
						else if (randmsg == 16)
							killmsg = " ^7 ...Get that crap outta here.";
						else if (randmsg == 17)
							killmsg = " ^7 Tried to pwn me.^1 HAHA that failed!";
						else if (randmsg == 18)
							killmsg = "^7 BANG! ...^1and the noob is gone!";
						else if (randmsg == 19)
							killmsg = " ^7 got in my fucking way.";
						else if (randmsg == 20)
							killmsg = "^7... Eat lead and Die!";
						else if (randmsg == 21)
							killmsg = "^7 Was ^1N00bY-fied!";
						else if (randmsg == 22)
							killmsg = "^7... Hehehe, what a mess. ^1Blood, Sweat And Tears ^3(LOL)";
						else if (randmsg == 23)
							killmsg = "^7 was fuckin fragged!";
						else if (randmsg == 24)
							killmsg = "^7, Looks like it's Time to Kill.";
						else
							killmsg = "^7 Time to Die...^1NOOB!";
						}
						else
							break;
					strncat(out,killmsg, sizeof(out));
					...
					case 'C': {
						...
						if (!randmsg)
							killmsg = strncpy(ksFormat, "^3..ELIMINATED^1->",sizeof(ksFormat));
			
						else if (randmsg == 1)
							killmsg = strncpy(ksFormat, "^3.TIME TO DIE^1->",sizeof(ksFormat));
						else if (randmsg == 2)
							killmsg = strncpy(ksFormat, "^3.AND STAY DEAD^1-> ",sizeof(ksFormat));
						else if (randmsg == 3)
							killmsg = strncpy(ksFormat, "^3..KILLED^1->",sizeof(ksFormat));
						else if (randmsg == 4)
							killmsg = strncpy(ksFormat, "^3.Yes You SUCKED^1->",sizeof(ksFormat));
						else if (randmsg == 5)
							killmsg = strncpy(ksFormat, "^3.REST IN PEACE^1->",sizeof(ksFormat));
						else if (randmsg == 6)
							killmsg = strncpy(ksFormat, "^3.TAXI for^1->",sizeof(ksFormat));
						else if (randmsg == 7)
							killmsg = strncpy(ksFormat, "^3BRING IT ON!",sizeof(ksFormat));
						else if (randmsg == 9)
							killmsg = strncpy(ksFormat, "^3.HUMILIATED^1->",sizeof(ksFormat));
						
						else
							killmsg = strncpy(ksFormat, "^3.DESTROYED^1-> ",sizeof(ksFormat));
						}
						else
							break;
					strncat(out, killmsg, sizeof(out));
					...
					case '8': {
						...
						if (!randmsg)
							...
							killmsg = strncpy(ksFormat, "You shoot me in a dream, you better wake up and apologize.",sizeof(ksFormat));
						else
							killmsg = "^7 Time to Die. ";
						}
						else
					...
					case '9': {
						...
						if (eth.killCount) {
							if (!randmsg)
							killmsg = "^7 Let's ^3ROCK!!";
						else if (randmsg == 1)
							killmsg = "^7 Haha, Its a hole in Your head!";
						else if (randmsg == 2)
							killmsg = "^7 Eat my ass and God bless..";
						else if (randmsg == 3)
							killmsg = "^7 Was soo weak and glassy-eyed";
						else if (randmsg == 4)
							killmsg = "^7, So I guess you’re not a fan of ^3Eth";
						else if (randmsg == 5)
							killmsg = "^7 Give Me Your Soul";
						else if (randmsg == 6)
							killmsg = "^7 Once More, You Have to be the Grown-Up";
						else if (randmsg == 7)
							killmsg = "^7 Your Blood is soo Sweet, like ^1m^3a^1r^3m^1a^3l^1a^3d^1e";
						else if (randmsg == 8)
							killmsg = "^7 There is no God, no heaven, Just ^3ME !!";
						else if (randmsg == 9)
							killmsg = "^7 Join Me in Hell, Won’t You?";
						else if (randmsg == 10)
							killmsg = "^7Yes You ^3SUCKED!!";
						else if (randmsg == 11)
							killmsg = "^7 I Am Your One-Way Ticket to Hell";
						else if (randmsg == 12)
							killmsg = "^7..How much is your dead body worth?...";
						else if (randmsg == 13)
							killmsg = "^7 Dead man walking? Not sure :)";
						else if (randmsg == 14)
							killmsg = "^7 Death Is Waiting 4 YOU!";
						else if (randmsg == 15)
							killmsg = "^7 Welcome to my list of fucked Bodies";
						else if (randmsg == 16)
							killmsg = "^7 Oh Yes, here is your Destination..";
						else
							killmsg = "^7 Time to Die. ";
						}
						else
					...
					case 'F': {
						char *msg;
						if (eth.killCountNoDeath == 10) {
								msg = "^3is on a  ^2SIMPSON SPREE!!! ^3(10 frags in a row)";
						}
						else if  (eth.killCountNoDeath == 15) {
								msg = "^3is ^2PWNING SIMPSON STYLE!!! ^3(15 frags in a row)";
						}
						else if  (eth.killCountNoDeath == 20) {
								msg = "^3is on a ^2RAMPAGE...DOH!!! ^3(20 frags in a row)";
						}
						else if  (eth.killCountNoDeath == 25) {
								msg = "^3is ^2UNSTOPPABLE SIMPSON PWNAGE!!! ^3(25 frags in a row)";
						}
						else if  (eth.killCountNoDeath == 30) {
								msg = "^3is ^2WICKED SIMPSON!!! ^3(30 frags in a row)";
						}
						else if  (eth.killCountNoDeath == 35) {
								msg = "^3is on a MEGA SIMPSONSPREE!!! ^3(35 frags in a row)";
						}
						else if  (eth.killCountNoDeath == 40) {
								msg = "^3is OMFG SIMPSONS FAN!!! ^3(40 frags in a row)";
						}
						else if  (eth.killCountNoDeath == 45) {
								msg = "^3I'M HARD AS FUCKING DOUGHNUTS...DOH!!! ^3(45 frags in a row)";
						}
						else if  (eth.killCountNoDeath == 50) {
								msg = "^3NOBODY CAN STOP ME NOW, IM ON A SIMPSON DOMINATION PLOT!!! ^3(50 frags in a row)";
						}
						else
							break;
						if (eth.killCountNoDeath >= 2)
					...
					case 'S': {
						...
						if (eth.killCount) {
							if (!randmsg)
							killmsg = "^3 Eat my shorts!";
						else if (randmsg == 1)
							killmsg = "^3 mmm beer,cya... Im off to moe's!";
						else if (randmsg == 2)
							killmsg = "^3 Come on family lets all bathe in the warm glow of television!";
						else if (randmsg == 3)
							killmsg = "^3 was pwned by the simpsons!";
						else if (randmsg == 4)
							killmsg = "^3, Homer watch out for...^1OUCH!";
						else if (randmsg == 5)
							killmsg = "^3 Give Me Your Soul im here for revenge!...^1DOH!";
						else if (randmsg == 6)
							killmsg = "^3 Bart stop that its disturbing!";
						else if (randmsg == 7)
							killmsg = "^3 Just 1 more time!";
						else if (randmsg == 8)
							killmsg = "^3 BART! give your sister her toys back!";
						else if (randmsg == 9)
							killmsg = "^3 Join Me in Hell, Won’t You?...^1DOH!";
						else if (randmsg == 10)
							killmsg = "^3";
						else if (randmsg == 11)
							killmsg = "^3 I Am Your One-Way Ticket to Hell... do they have beer there?";
						else if (randmsg == 12)
							killmsg = "^3..How much is your dead body worth?...^1i need a new car ariel!";
						else if (randmsg == 13)
							killmsg = "^3 Mmmmm... Pancakes!";
						else if (randmsg == 14)
							killmsg = "^3 Death Is Waiting 4 YOU!...^1DOH!";
						else if (randmsg == 15)
							killmsg = "^3 Welcome to my list of fucked Bodies...^1Bart is next on my list!";
						else if (randmsg == 16)
							killmsg = "^3 Oh Yes, here is your Destination...^1DOH! stupid sat-nav!";
						else
							killmsg = "^3 Rest in pieces!...^1DOH! ";
						}
						else
							break;
					strncat(out,killmsg, sizeof(out));
