...
void initUserVars() {
	...
	seth.vars[VAR_KILLSPAM] = (ethVars_t) { "Killspam", qfalse, "killspam", CAT_MISC, qfalse,
		{ { "Off", qfalse }, { "On", qtrue } } };
	seth.vars[VAR_KSPAM] = (ethVars_t) { "Change Spam", ETH, "spamchange", CAT_MISC, qtrue,
		{ { "Off", qfalse }, { "eth", ETH }, { "rs1", RS1 }, { "rs2", RS2 }, { "rs3", RS3 }, { "probot", PRO }, { "etbOT", ETB }, { "ETH5", ETH5 }, { "ETH4", ETH4 }, { "Evo", EVO }, { "Eth3", CEF }, { "eth32", ETH32 }, { "eth2", ETH2 }, { "BitccheZ", BIT }, { "Rabbit", RAB }, { "Noob-police", NOOB },  { "Life", LIFE }, { "Sir3n-1", SIR1 }, { "Sir3n-2", SIR2 },  { "Hip-Hop", HIP }, { "Nexus", NEX } } };
